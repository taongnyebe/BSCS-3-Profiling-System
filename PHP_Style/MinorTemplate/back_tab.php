<section class="container-fluid bg-primary mt-5 px-5 pb-0">
      <div class="align-items-start">
            ...
            <?php 
                  ...
                  echo ($button>1 && $button<4)?'<a href="./" class="btn float-end"><img src="./Assets/icons/AWARDS_ICON.png" alt="" style="width: 5vh"></a> &emsp;':"";
                  echo ($button>3)?'<a href="./" class="btn float-end"><img src="./Assets/icons/DELETE_ICON.png" alt="" style="width: 5vh"></a> &emsp; <a href="./" class="btn float-end"><img src="./Assets/icons/EDIT_ICON.png" alt="" style="width: 5vh"></a>':"";
