<?php 
      ...
      if (isset($_POST['submit'])){
            ...
            $sql1 = (($_GET['use'] == "Add")? "INSERT INTO" : "UPDATE")
                  ...
                  ." fb_name='$fb_name', home=\"$home\", boarding=\"$boarding\", g1_first_name='$g1_first_name', g1_middle_name='$g1_middle_name', g1_family_name='$g1_family_name', g1_suffix='$g1_suffix', g1_contact='$g1_contact',"
                  ." g2_first_name='$g2_first_name', g2_middle_name='$g2_middle_name', g2_family_name='$g2_family_name', g2_suffix='$g2_suffix', g2_contact='$g2_contact'"
